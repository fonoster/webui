          ...
          <div className="absolute inset-0 py-6 px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 gap-4 mt-8">
              {projects.map(project => (
                <div
                  key={project.ref}
                  className="h-48 min-h-full relative rounded-lg bg-gray-700 p-6 shadow-sm flex space-x-4 justify-between flex-col"
                >
                  <div
                  ...
                  >
                    ...
                    <div>
                      ...
                      <Text className="m-0 p-0 text-sm truncate max-w-[90%]">
                        {project.ref}
                      </Text>
                    </div>
                  </div>
