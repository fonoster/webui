        ...
        {({ open }) => (
          <>
            <div className="relative inline-flex">
              <Menu.Button className="bg-gray-700 p-1 rounded-full text-gray-400 hover:text-gray-300 focus:outline-none">
            ...
            >
              <Menu.Items className="z-10 origin-top-right absolute overflow-y-auto max-h-[32rem] min-h-[240px] mt-2 w-80 rounded-md shadow-lg py-2 bg-gray-700 focus:outline-none right-0">
                  ...
                  <Menu.Item key={event.ref}>
                    {() => (
                      <Link href={`/monitor/${event.eventType}`}>
                        <a
                          className={classes(
                            'flex w-full p-4 text-gray-300 text-left hover:bg-gray-600'
                          )}
                        >
                          <div
                            className={classes(
