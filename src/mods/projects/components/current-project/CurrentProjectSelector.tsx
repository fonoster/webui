            ...
            <div className="w-full relative mt-6">
              ...
              >
                ...
                <div>
                  ...
                  <span className="font-sm text-gray-300">Current project</span>
                </div>
              ...
              <Transition
                ...
                leaveTo="opacity-0"
              >
                <Listbox.Options className="absolute z-10 mt-1 ml-2 w-[92%] bg-gray-700 shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
                  {projects.map(item => (
                    <Listbox.Option
                      key={item.ref}
                      className={({ active }) =>
